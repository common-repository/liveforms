...
class Location {
	...
	public function control_button() {
		ob_start();
		?>
		<li class="<?= $this->field_control_class; ?>" data-type="<?php echo __CLASS__ ?>" for="Location">
			<span class="lfi lfi-name"><i class="fas fa-globe-americas"></i></span> Country
			<a title="Location" rel="Location" class="add pull-right add-form-field" data-template='Location' href="#"><i class="fas fa-plus-circle ttipf" title=""></i></a>
	    </li>
	    <?php
